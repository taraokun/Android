...
import to.msn.wings.fooddatabase.dao.ShopMapSearchDao;
...
public class SubActivity2 extends AppCompatActivity implements View.OnFocusChangeListener, SearchView.OnQueryTextListener{
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        List<MapSearch> all_search_list;
        ...
        for(MapSearch search_data: all_search_list) {
            ...
            // 個数
            TextView textNumber = setTextItem(String.valueOf(search_data.getSearchHolidayMonth()), GE);      // TextViewのカスタマイズ処理
            // 単価
            TextView textPrice = setTextItem(String.valueOf(search_data.getSearchTime1()), GE);      // TextViewのカスタマイズ処理
