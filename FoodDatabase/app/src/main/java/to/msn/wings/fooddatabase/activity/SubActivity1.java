package to.msn.wings.fooddatabase.activity;
...
import to.msn.wings.fooddatabase.dao.ShopLocationDao;
...
public class SubActivity1 extends AppCompatActivity implements View.OnFocusChangeListener, SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shopLocationDao = new ShopLocationDao(this);
    ...
    public boolean onQueryTextSubmit(String query) {
        ...
        // ヘッダー：個数
        TextView headerNumber = setTextItem("緯度", GCH);
        TableRow.LayoutParams paramsNumber = setParams(0.3f);
        // ヘッダー：単価
        TextView headerImage = setTextItem("経度", GCH);
        ...
        List<LocationInformation> all_search_list;
        all_search_list = shopLocationDao.findAll();

        for(LocationInformation search_data: all_search_list) {
            ...
            // 個数
            TextView textNumber = setTextItem(String.valueOf(search_data.getLatitude()), GE);      // TextViewのカスタマイズ処理
            // 単価
            TextView textPrice = setTextItem(String.valueOf(search_data.getLongitude()), GE);      // TextViewのカスタマイズ処理
