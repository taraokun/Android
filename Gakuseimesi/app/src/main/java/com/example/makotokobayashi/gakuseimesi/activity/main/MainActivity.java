package com.example.makotokobayashi.gakuseimesi.activity.main;
...
import com.example.makotokobayashi.gakuseimesi.activity.SubActivity2;
import com.example.makotokobayashi.gakuseimesi.activity.main.expandLayout.ResizeAnimation;
import com.example.makotokobayashi.gakuseimesi.activity.main.expandLayout.StoreInformationLayout;
import com.example.makotokobayashi.gakuseimesi.activity.storeInfomation.StoreInfomationActivity;
import com.example.makotokobayashi.gakuseimesi.database.basicData.MapSearch;
import com.example.makotokobayashi.gakuseimesi.database.dao.ShopMapSearchDao;
import com.example.makotokobayashi.gakuseimesi.gurunavi.UploadAsyncTask;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void UploadDatabase(){
        ...
        int before_entry_year = sharedPref.getInt("before_entry_year", 9999);
        int before_entry_month = sharedPref.getInt("before_entry_month", 9999);
        int before_entry_day = sharedPref.getInt("before_entry_day", 9999);
    ...
    private void customLayoutSet(){
        storeInformationLayout.setShopImage(null);
        storeInformationLayout.setShopName("shopname");
        storeInformationLayout.setShopHour("shophour");
        storeInformationLayout.setEditText("あいうえお");
        storeInformationLayout.setEditText2("あいうえお");
        storeInformationLayout.setEditText3("あいうえお");
    }
}